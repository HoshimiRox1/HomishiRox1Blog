...
- 冷白背景。
- 黑色粗边框。
- 柔化后的粗野形态：胶囊、圆角矩形和圆角白板，而不是普通直角矩形。
- 低透明网格。
- Profile 页面主色 `#B9F5FF`。
- pastel 辅助色作为贴纸色块。
...
贴纸是 Profile 的内容主体。每张贴纸使用纯色底、黑色粗边和圆角矩形，不使用白色贴条，不使用阴影。
...
- 冷白 / 纸白背景。
- 黑色粗边框。
- 柔化粗野主义元素：白板、身份卡、贴纸、标签优先使用胶囊或圆角矩形，不使用普通直角矩形作为默认形态。
- Profile 浅青主色 `#B9F5FF`。
- pastel 贴纸色块。
- 强字体、短文案、高字重。
- 清晰的白板结构。
